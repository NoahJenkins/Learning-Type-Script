...
let menu = [
    {id: 1, name: "Cheese", price: 8}, 
    {id: 2, name: "Pepperoni", price: 10},
    {id: 3, name: "Veggie", price: 8},
    {id: 4, name: "Pineapple", price: 10}
]
...
addNewPizza({ id: 7, name: "Spicey Sausage", price: 10})
...
console.log("Order que:", orderQue)